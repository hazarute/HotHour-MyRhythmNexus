...
async def create_auction(auction_in: AuctionCreate, admin=Depends(get_current_admin_user)):
    try:
        ...
        return {
            ...
            "scheduled_at": getattr(auction, "scheduledAt", None),
    ...
    for a in items:
        ...
        if not isinstance(a, dict):
            ...
            mapped.append({
                ...
                "end_time": a.endTime,
                "scheduled_at": getattr(a, "scheduledAt", None) or getattr(a, "endTime", None),
                ...
                "locked_price": getattr(getattr(a, "reservation", None), "lockedPrice", None),
            ...
            mapped.append({
                ...
                "allowed_gender": a.get("allowed_gender") if a.get("allowed_gender") is not None else a.get("allowedGender", "ANY"),
                ...
                "locked_price": a.get("locked_price"),
...
async def get_auction(request: Request, auction_id: int = Path(..., gt=0)):
    ...
    return {
        ...
        "floor_price": auction.floorPrice,
        "start_time": auction.startTime,
        "scheduled_at": getattr(auction, "scheduledAt", None) or auction.endTime,
        "end_time": auction.endTime,
        "drop_interval_mins": auction.dropIntervalMins,
        "drop_amount": auction.dropAmount,
