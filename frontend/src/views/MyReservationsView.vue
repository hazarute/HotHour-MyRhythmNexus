...
<template>
    <div class="hh-section max-w-5xl py-8 lg:py-12">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-slate-800 pb-6 mb-8">
            <div>
                <h1 class="text-3xl md:text-4xl font-black text-white tracking-tight">Rezervasyonlarým</h1>
                <p class="text-slate-400 text-base mt-2">Yaklaþan Pilates oturumlarýnýz ve geçmiþ rezervasyonlarýnýz.</p>
            </div>
    ...
    <div v-else-if="reservations.length === 0" class="hh-card text-center py-20">
        ...
        <p class="text-gray-500 mb-6">Henüz bir oturum rezerve etmediniz. Þu an neyin popüler olduðuna göz atýn!</p>
        <router-link to="/" class="hh-btn-neon">
            Canlý Oturumlarý Ýncele
        </router-link>
    </div>
                ...
                <div class="text-xs text-gray-500 uppercase tracking-wider mb-1">Rezervasyon Kodu</div>
                    ...
                    {{ res.booking_code }}
                                ...
                                <div class="text-[10px] text-slate-400 text-center max-w-[150px]">
                                        Giriþ yapmak için bu kodu resepsiyonda gösterin
                </div>
                            </div>
                            ...
                            <div class="md:w-[180px] p-3 flex flex-col gap-2">
                                ...
                                <button class="hh-btn-ghost w-full text-xs uppercase tracking-wide">Fiþi Göster</button>
                            </div>
            </div>
        </div>
    </div>
